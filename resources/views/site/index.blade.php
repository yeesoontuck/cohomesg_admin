                ...
                <div class="grid grid-cols-5 gap-8">
                    <div class="flex flex-col items-center">
                        <div class="p-4 bg-white border-2 border-[#D8B06C] rounded-2xl mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="text-[#D8B06C] w-6 h-6"
                                viewBox="0 0 576 512">
                                <path
                    ...
                    <div class="flex flex-col items-center">
                        <div class="p-4 bg-white border-2 border-[#D8B06C] rounded-2xl mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" id="icon-price-tag" viewBox="0 0 32 32" fill="currentColor" class="text-[#D8B06C] w-6 h-6">
                                <path
                    ...
                    <div class="flex flex-col items-center">
                        <div class="p-4 bg-white border-2 border-[#D8B06C] rounded-2xl mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" id="icon-phone" viewBox="0 0 32 32" fill="currentColor" class="text-[#D8B06C] w-6 h-6">
                                <path

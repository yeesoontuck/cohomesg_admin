<x-app>
    <main id="main" x-data="{ open: false, deleteUrl: '' }" class="flex-1 dark:text-white">
        ...
        <form action="{{ route('onboarding.password.set') }}" method="POST" x-data="{
            password: '',
            rules: {
                length: p => p.length >= 8,
                number: p => /[0-9]/.test(p),
            ...
            <div class="mb-4">
                ...
                To get you started securely, we need you to create a unique password.<br />
                This replaces your temporary invitation link and ensures only you can access your new workspace.
            </div>
